...
public class ShareController {
    ...
    @ApiOperation(value = "토픽 공유 데이터 조회")
    @GetMapping("/topics//{topicId}")
    public ShareInfo selectShareInfo(@PathVariable Long topicId, UserInfo userInfo) throws NoSuchProviderException, NoSuchAlgorithmException {
        // 토픽의 읽기 권한 체크
    ...
    public AccessCodeResponse updateAccessCode(@PathVariable Long accessCodeId, UserInfo userInfo) throws NoSuchProviderException, NoSuchAlgorithmException {
        AccessCode accessCode = accessCodeService.createAccessCode(userInfo.getId());
