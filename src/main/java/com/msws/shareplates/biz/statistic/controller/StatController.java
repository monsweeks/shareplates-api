...
public class StatController {
	...
	public Map<String, Object> stats(@PathVariable Long shareId, 
		...
		List<UserAccessCount> share_info = statService.getDataBetweenSpecificTime(shareId, Timestamp.valueOf(startDate.minusHours(kr_timezone)), Timestamp.valueOf(endDate.minusHours(kr_timezone)));
		List<UserAccessCount> share_page_chagned = statService.getDetailDataBetweenSpecificTime(shareId, Timestamp.valueOf(startDate.minusHours(kr_timezone)), Timestamp.valueOf(endDate.minusHours(kr_timezone)));
		
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("access_info", share_info);
		result.put("pagechanged_info", share_page_chagned);
		return result;
	}
