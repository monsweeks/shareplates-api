...
public class StatService {
	...
	public void writePageChanged(Long topicId, Long shareId, Long chapterId, Long pageId) {
		mainService.setData(shareService.selectShare(shareId),  null , "page_change");
	}
	...
	public void writeJoinUser(Long topicId, Long shareId, Long userId) {
		// 새로운 사용자가 참여함
		// 새로운 사용자의 세션이 1개 추가됨
		mainService.setData(shareService.selectShare(shareId),  userId , "join");
	}
	...
	public void writeDisconnectUser(Long topicId, Long shareId, Long userId) {
		// 사용자가 나감
		// 사용자의 세션이 1개 감소됨
		mainService.setData(shareService.selectShare(shareId),  userId , "out");
	}
	...
	public void writeUserFocusChange(Long topicId, Long shareId, Long userId, Boolean focus) {
		// 사용자의 포커스 여부가 변경됨
		mainService.setData(shareService.selectShare(shareId),  userId , "focus_out");
	}
