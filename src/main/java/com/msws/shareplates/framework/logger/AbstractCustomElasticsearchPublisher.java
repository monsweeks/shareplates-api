...
public abstract class AbstractCustomElasticsearchPublisher<T> implements Runnable {
	...
	private CustomElasticsearchAggregator outputAggregator;
	...
	public AbstractPropertyAndEncoder<T> getIndexPattern(){
		return indexPattern;
	}

	public AbstractCustomElasticsearchPublisher(Context context, ErrorReporter errorReporter, Settings settings, ElasticsearchProperties properties, HttpRequestHeaders headers) throws IOException {
	...
	private static CustomElasticsearchAggregator configureOutputAggregator(Settings settings, ErrorReporter errorReporter, HttpRequestHeaders httpRequestHeaders)  {
		CustomElasticsearchAggregator spigot = new CustomElasticsearchAggregator(settings, errorReporter);
	...
	protected abstract void serializeIndexString(JsonGenerator gen, T event) throws IOException;
