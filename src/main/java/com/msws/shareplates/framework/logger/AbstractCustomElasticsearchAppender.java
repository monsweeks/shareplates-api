...
public abstract class AbstractCustomElasticsearchAppender<T> extends UnsynchronizedAppenderBase<T> {

	protected Settings settings;
    protected ElasticsearchProperties elasticsearchProperties;
    protected AbstractCustomElasticsearchPublisher<T> publisher;
    protected ErrorReporter errorReporter;
	protected HttpRequestHeaders headers;

	public AbstractCustomElasticsearchAppender() {
		this.settings = new Settings();
		this.headers = new HttpRequestHeaders();
	}

    public AbstractCustomElasticsearchAppender(Settings settings) {
    ...
    //VisibleForTesting
    protected abstract AbstractCustomElasticsearchPublisher<T> buildElasticsearchPublisher() throws IOException;
